...
<html lang="en">
   <head>
      ...
      <script src="{{ URL::asset('js/portal/jquery-2.1.1.min.js') }}"></script>
      <script src="{{ URL::asset('js/portal/main.min.js') }}"></script>
      <!-- laod styles -->
      <link rel="stylesheet" href="{{ URL::asset('css/portal/main.min.css') }}">
      <link rel="stylesheet" href="{{ URL::asset('css/portal/fonts.css') }}">
   </head>
   <body>
      <div id="prefpage">
         ...
         <div id="bg">
            <img src="{{ URL::asset('img/portal/artwork_400x400bb.jpg') }}" alt=""/>
         </div>
         <img src="{{ URL::asset('img/portal/play_button.svg') }}" style="display:none"/>
         <img src="{{ URL::asset('img/portal/pause_button.svg') }}" style="display:none"/>
         ...
         <div id="service" class="service-container">
            ...
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_runthejewels.svg') }}" alt="runthejewels"/>
            ...
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_itunes.svg') }}" alt="itunes"/>
            ...
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_spotify.svg') }}" alt="spotify"/>
            ...
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_applemusic.svg') }}" alt="applemusic"/>
               <span class="play">Play</span>
               </a>
            </div>
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_google-play.svg') }}" alt="google-play"/>
               <span class="play">Play</span>
               </a>
            </div>
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_fnac.svg') }}" alt="fnac"/>
            ...
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_deezer.svg') }}" alt="deezer"/>
               <span class="play">Play</span>
               </a>
            </div>
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_napster.svg') }}" alt="napster"/>
               <span class="play">Play</span>
               </a>
            </div>
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_rhapsody.svg') }}" alt="rhapsody"/>
               <span class="play">Play</span>
               </a>
            </div>
            <div class="service">
               <a class="img-btn redirect"
                  ...
                  data-apptype="manual"
                  >
               <img class="" width="125px" height="40px" style="display:inline-block;" src="{{ URL::asset('img/portal/music-service_youtube.svg') }}" alt="youtube"/>
               <span class="play">Play</span>
               </a>
            </div>
         ...
         <div id="loader-spinner" class="loader-image"><img src="{{ URL::asset('img/portal/bx_loader.gif') }}" alt="Loading"></div>
      </div>
            ...
            <div class="modal-dialog" role="document">
               <div class="modal-content">
                  <div class="modal-header">
                     <div class="closeBtn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><img src="{{ URL::asset('img/portal/close2.svg') }}" alt="" /></span></div>
